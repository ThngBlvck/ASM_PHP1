...
$query = "SELECT id as product_id, name, content, price, thumbnail FROM products WHERE id = $id";
...
<section id="product-detail" class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="./upload/<?= $product['thumbnail'] ?? '' ?>" alt="Product Image" class="img-fluid" width="250px" height="180px">
            </div>
